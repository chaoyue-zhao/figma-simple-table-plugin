...
figma.ui.onmessage = (msg) => __awaiter(this, void 0, void 0, function* () {
    const { type, modifiedData, numberOfRows, numberOfCols, width, fontSize, fontColour, fontFamily, letterSpacing, lineHeight, header } = msg;
    if (type === "data-received") {
        const height = lineHeight * numberOfRows;
        const nodes = [];
        function loadFonts(fontWeight) {
        ...
        if (header === "yes") {
            yield loadFonts('Regular');
            yield loadFonts('Bold');
        }
        else {
            yield loadFonts('Regular');
        }
